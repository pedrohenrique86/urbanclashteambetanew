  ...
  useEffect(() => {
    const handleAlert = (data: { username: string, expiresAt: number }) => {
      if (faction === 'guardas') {
        ...
        showToast(`ALERTA NÍVEL 5: ${data.username} executando Golpe de Mestre!`, 'warning', 5000);
