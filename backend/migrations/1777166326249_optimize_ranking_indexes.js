...
exports.up = (pgm) => {
  ...
  pgm.createIndex('user_profiles', ['level', 'total_xp'], { name: 'idx_user_profiles_ranking_performance', method: 'btree', opclass: 'DESC' });

  // Índices para ordenação de ranking de clãs
  pgm.createIndex('clans', ['season_score', 'member_count'], { name: 'idx_clans_ranking_performance', method: 'btree', opclass: 'DESC' });
};
